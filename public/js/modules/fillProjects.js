...
export const fillProjects = async () => {
    ...
    reposData.forEach(repo => {
            ...
            if((repo.topics).includes("deployed")){
                ...
                const objectList = document.createElement("li");
                objectList.className = "flex flex-wrap w-full bg-gray-hover rounded-xl mb-3 items-center xl:h-20 h-40 xl:px-10 xl:py-0 px-10 py-10 hover:translate-x-0.5 hover:-translate-y-0.5 transition-all";
                objectList.innerHTML = `

                        <div class="xl:w-[23%] w-1/3 flex items-center">
                        ...
                        <div class="xl:w-[27%] w-1/3 p-2 flex items-center">
                        ...
                        <div class="xl:w-[29%] w-1/3 flex items-center xl:-m-4">
