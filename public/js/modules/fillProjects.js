...
export const fillProjects = async () => {
    ...
    reposData.forEach(repo => {
            if((repo.topics).includes("deployed")){
                ...
                const objectList = document.createElement("li");
                objectList.className = "flex flex-wrap w-full bg-gray-hover rounded-xl mb-3 items-center h-20 px-10 justify-between";
                objectList.innerHTML = `
                ...
                <div class=" flex items-center">
                        ...
                        <div class=" flex items-center">
                            <a href="${repo.homepage}" target="blank" class="relative z-10 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 text-green">
                                ...
                                <span class="ml-2 text-green">${repo.homepage}</span>
                            </a>
                          </div>
                        ...
                        <div class=" flex items-center">
                          <span class="w-full bg-[#32d49e43] rounded-lg px-10 text-center py-3 text-[#32d49e] text-sm font-semibold deployed">Desplegado</span>
                        </div>
