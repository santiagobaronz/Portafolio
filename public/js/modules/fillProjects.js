    ...
    reposData.forEach(repo => {
            ...
            if((repo.topics).includes("deployed")){
                ...
                objectList.innerHTML = `
                        ...
                        <div class="w-[29%] flex items-center -m-4">
                        ...
                        <div class="flex items-center justify-end">
                          <span class="w-full bg-[#32d49e43] rounded-lg px-7 text-center py-3 text-[#32d49e] text-sm font-semibold deployed">Desplegado</span>
                        </div>
